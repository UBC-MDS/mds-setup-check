...
| `check-raw-passthrough.qmd` | `uv run quarto render` | isolates the two constructs pandoc forwards instead of parsing, which fail on opposite routes |
...
`check-notebook-table.ipynb` and `check-raw-passthrough.qmd` are the exceptions:
each holds a construct or two and nothing else, and a dash means the fixture does
not contain that feature at all, which is a different statement from a cross.

`check-raw-passthrough.qmd` is worth reading if you write assignments. Its two
constructs fail on *opposite* routes -- Typst drops a raw `\footnote{}`, LaTeX drops
a literal `α` inside `\text{}` -- which is why they are isolated here instead of
making two otherwise healthy routes look broken. Both are silent.
...
| input | rendered by | output | accented latin | degree sign | en dash | curly quotes | inline maths | display eqn | aligned eqns | literal Greek | emoji | middot | numbered eqn | markdown table | raw LaTeX | markdown note | Greek in text{} | image |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| `check-raw-passthrough.qmd` | Quarto | LaTeX PDF | — | — | — | — | — | — | — | — | — | — | — | — | ✅ | ✅ | ❌ | — |
| `check-raw-passthrough.qmd` | Quarto | Typst PDF | — | — | — | — | — | — | — | — | — | — | — | — | ❌ | ✅ | ✅ | — |
| `check-raw-passthrough.qmd` | Quarto | HTML | — | — | — | — | — | — | — | — | — | — | — | — | ❌ | ✅ | ✅ | — |
...
| rendered by | output | accented latin | degree sign | en dash | curly quotes | inline maths | display eqn | aligned eqns | literal Greek | emoji | middot | numbered eqn | markdown table | raw LaTeX | markdown note | Greek in text{} | image |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Quarto | LaTeX PDF | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ✅ | ✅ | — | — | — | ✅ |
| Quarto | Typst PDF | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | — | — | — | ✅ |
| Quarto | HTML | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | — | — | — | ✅ |
...
| `check-raw-passthrough.qmd` | the LaTeX pandoc forwards rather than parses, isolated: raw `\footnote{}` and a literal `α` inside `\text{}` |
