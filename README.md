...
Building an assignment repo: **[docs/assignment-workflow-uv.md](docs/assignment-workflow-uv.md)**.
...
| `docs/` | the longer-form guides, and [`render-matrix.md`](docs/render-matrix.md) -- which features survive which route, generated by `make matrix` |
...
| [`docs/assignment-workflow-uv.md`](docs/assignment-workflow-uv.md) | how to build an MDS assignment repo |
| [`docs/using-atkinson-hyperlegible.md`](docs/using-atkinson-hyperlegible.md) | optional: a more legible typeface |
